...
void setBoneRotation(void)
{
	...
	// till vertexshadern
	glUniformMatrix4fv(glGetUniformLocation(g_shader, "rotBones_0"),1,GL_TRUE, g_bones[0].rot.m);
	glUniformMatrix4fv(glGetUniformLocation(g_shader, "rotBones_1"),1,GL_TRUE, g_bones[1].rot.m);
